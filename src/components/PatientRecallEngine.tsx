...
export function PatientRecallEngine() {
  ...
  return (
    <div className="w-full rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 sm:p-7 shadow-xs">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[var(--color-border)] pb-5">
        <div>
          ...
          <p className="text-sm font-medium text-[var(--color-text-secondary)] mt-1 max-w-2xl leading-relaxed">
            Automated follow-up and care plan recovery via personalized clinical SMS.
          </p>
        </div>
      ...
      {/* Main Grid: Patient List Table (50%) + AI SMS Dispatcher (50%) */}
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Left: Patient Recall Radar Table (50%) */}
        <div className="rounded-xl border border-slate-300 dark:border-slate-700 bg-[var(--color-surface)] overflow-hidden shadow-xs">
        ...
        {/* Right: AI Re-Engagement Message Generator (50%) */}
        <div className="rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50/70 dark:bg-slate-900/40 p-5 flex flex-col justify-between shadow-xs">
          <div>
